...
import org.luisgm.projektgb.controll.RoleFacade;
...
public class RoleController implements Serializable {
    ...
    @EJB
    private org.luisgm.projektgb.controll.RoleFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("util/Bundle").getString("RoleCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("util/Bundle").getString("RoleUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("util/Bundle").getString("RoleDeleted"));
        if (!JsfUtil.isValidationFailed()) {
