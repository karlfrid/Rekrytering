...
import org.luisgm.projektgb.controll.PersonFacade;
...
public class PersonController implements Serializable {
    ...
    @EJB
    private org.luisgm.projektgb.controll.PersonFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("util/Bundle").getString("PersonCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("util/Bundle").getString("PersonUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("util/Bundle").getString("PersonDeleted"));
        if (!JsfUtil.isValidationFailed()) {
